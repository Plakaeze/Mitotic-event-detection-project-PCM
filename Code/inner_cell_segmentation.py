...
with open("C:\\Mitotic Event Detection\\Code\\full_mito_path", "rb") as fp:   # Unpickling
...
#         mito_fac = 1/(mn_eu2/mn_eu1)
#         mitosis_factors.append(mito_fac)
        
#         path_ind = path_ind+1
    
#     arr_mitosis_factors = np.asarray(mitosis_factors)    
#     mitosis_frame = start_frame + np.argmax(arr_mitosis_factors)
#     mito_labels = path[np.argmax(arr_mitosis_factors)]
...
column_features = ['Area of mother cell','Major axis of mother cell','Minor axis of mother cell',
                    ...
                    'Max intensity of phenomenon','Min intensity of phenomenon','Extent of phenomenon',
...
for fmp in range(len(full_mito_path)):
    ...
    opt_th_for_phe = threshold_li(cropped)
    area_phe = cropped > opt_th_for_phe
    # area_phe = cropped > 2800
    ...
    features_list = [area_m,maj_m,mi_m,cir_m,mean_int_m,max_int_m,min_int_m,
                ...
                area_phe,maj_phe,mi_phe,cir_phe,mean_int_phe,max_int_phe,min_int_phe,ext_phe,
...
path_save_features = 'C:\\Mitotic Event Detection\\Features\\'
